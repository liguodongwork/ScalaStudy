...
object Main {
  def main(args: Array[String]) {
    val books:List[Book] = List(
      ...
      Book("Principles of Compiler Design", List("Aho,Alfred","Ullman, Jeffrey","Gosling kk") ),
      Book("Programing in Modula-2",List("Wirth,Niklaus")),
    ...
    val resultIndex = for (b <- books if (b.title indexOf "Programming") >= 0 ) yield b.title
    println(resultIndex)
